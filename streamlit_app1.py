...
if not st.session_state.configured:
    ...
    # Input
    st.markdown('<div class="input-wrap"><div class="input-hint">Nova consulta ao agente</div>', unsafe_allow_html=True)
    c1, c2 = st.columns([5, 1])
    with c1:
        user_input = st.text_input("q", placeholder="Pergunte sobre filmes, diretores, Oscar...", label_visibility="collapsed", key="q")
    with c2:
